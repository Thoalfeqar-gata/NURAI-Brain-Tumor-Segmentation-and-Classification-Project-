...
class MLPDecoder(nn.Module):
    def __init__(self, channel_dims = [96, 192, 384, 768], hidden_dim = 256):
        ...
        self.final_conv = nn.Sequential(
            ...
            nn.Conv2d(in_channels = hidden_dim, out_channels = 1, kernel_size = 1, stride = 1, padding = 0)
        )
...
class BrainTumorModel(nn.Module):
    def __init__(self, num_classes = 4, dropout_ratio = 0.1):
        ...
        self.decoder = MLPDecoder(channel_dims = channel_dims, hidden_dim = 256)
    ...
    def forward(self, x):
        ...
        # Upsample segmentation logits to original input resolution
